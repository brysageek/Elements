    ...
    internal class ChemicalElementList : List<ChemicalElement>
    {
        public ChemicalElementList()
        {
            ...
            Add(new ChemicalElement(4, 4, 22,
                ...
                658.8f,
                1.54f,
                MetalClassificationTypes.TransitionMetal));
            ...
            Add(new ChemicalElement(5, 7, 91,
                231.0358f, "Protactinium", "Pa", 568.0f,
                1.50f, MetalClassificationTypes.Actinoid));

            Add(new ChemicalElement(6, 7, 92,
                238.0289f, "Uranium", "U", 597.6f,
                1.38f, MetalClassificationTypes.Actinoid));
